...
import com.jesusbadenas.kotlin_clean_architecture_project.presentation.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            window.apply {
                ...
                statusBarColor = ContextCompat.getColor(this@MainActivity, R.color.primary_light)
            }
        }
    }
}
